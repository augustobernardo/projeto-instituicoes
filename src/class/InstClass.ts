...
class InstituicoesArray {
    ...
    constructor() {
        this.instituicoes = [
            new Instituicoes(1, 'Casa do Zezinho', 
            ...
            new Instituicoes(2, 'Projeto Guri',
            ...
            new Instituicoes(3, 'Instituto do Câncer Infantil',
            ...
            new Instituicoes(4, 'Associação VagaLume',
            ...
            new Instituicoes(5, 'Projeto Velho Amigo',
                                'promover a cultura de inclusão do idoso, assegurando seus direitos e valorizando sua contribuição para a sociedade.',
